...
public:
	...
	//이미지 리소스 초기화
	HRESULT init(DWORD resID, int width, int height, bool isTrans = true, COLORREF transColor = RGB(255, 0, 255));
	//이미지 파일 초기화(주사용)
	...
	void scaleRender(HDC hdc, int destX, int destY, float scaleW, float scaleH);
